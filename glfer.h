...
typedef enum { SOURCE_NONE, SOUNDCARD_SOURCE, FILE_SOURCE } datasource_t;

typedef enum { NO_AVG, AVG_SUMAVG, AVG_PLAIN, AVG_SUMEXTREME } avgmode_t;
...
typedef struct {
    ...
    size_t data_block_size;    /* number of samples used for the FFT */
