...
double bessel_I0(double x) { /* modified Bessel function of the first kind */
    double ax, ans;
    double y;
    ...
    if ((ax = fabs(x)) < 3.75) {
        ...
        ans = 1.0 +
            y *
                (3.5156229 +
                 y * (3.0899424 + y * (1.2067492 + y * (0.2659732 + y * (0.360768e-01 + y * 0.45813e-02)))));
    } else {
        y = 3.75 / ax;
        ans = (exp(ax) / sqrt(ax)) *
            (0.39894228 +
                           ...
                           (-0.157565e-02 +
                            y *
                                (0.916281e-02 +
                                 y *
                                     (-0.2057706e-01 +
                                      y * (0.2635537e-01 + y * (-0.1647633e-01 + y * 0.392377e-02))))))));
    }
