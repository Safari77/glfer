...
static void version();
static void parse_args(int argc, char *argv[], char **device, int *sample_rate, size_t *n);
    ...
    */
    ...
    if (glfer.init_done == FALSE) {
        ...
        if (dev_status == 0) {
            ...
            show_message(
                "No control port is defined for the transmitter!\n"
                "\n"
